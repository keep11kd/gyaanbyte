...
import { authBrand, authFeatures, forgotPasswordContent } from "../data";
import type { ForgotPasswordFormValues } from "../types";

export interface ForgotPasswordSectionProps {
  /** Callback fired upon submitting password reset form */
...
export default function ForgotPasswordSection({
  ...
  successMessage = null,
  className = "",
}: Readonly<ForgotPasswordSectionProps>) {
  return (
    <section className={`relative min-h-screen overflow-hidden bg-slate-950 ${className}`.trim()}>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
          {/* Left Panel: Recovery Marketing & Security Context */}
          <div className="hidden lg:block">
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-slate-400">
                Forgot your password? Don&apos;t worry. We&apos;ll help you securely recover
                access to your GyaanByte account in just a few simple steps.
              </p>

              {/* Security & Feature Highlights List */}
              <div className="mt-10 grid gap-4">
                {authFeatures.slice(2).map((feature) => {
          ...
          {/* Right Panel: Auth Card & Password Reset Form */}
          <div className="mx-auto w-full max-w-lg">
            <AuthCard>
              <AuthHeader content={forgotPasswordContent} />
