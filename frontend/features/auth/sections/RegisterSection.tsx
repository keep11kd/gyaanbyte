...
import { authBrand, authFeatures, registerContent } from "../data";
import type { RegisterFormValues, SocialProviderId } from "../types";

export interface RegisterSectionProps {
  /** Callback fired upon submitting registration form */
  onRegisterSubmit?: (values: RegisterFormValues) => Promise<void> | void;
  ...
  /** Top-level API registration error message */
    ...
    <section className={`relative min-h-screen overflow-hidden bg-slate-950 ${className}`.trim()}>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="hidden lg:block">
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-slate-400">
                Join thousands of learners building real-world software,
                mastering modern technologies, and accelerating their careers
          ...
          {/* Right Side: Auth Card & Registration Form */}
          <div className="mx-auto w-full max-w-lg">
            <AuthCard>
              <AuthHeader content={registerContent} />
